          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav navbar-right mr-2">
              <li className="nav-item my-auto mx-3">
                <a className="nav-link text-dark" href="/login">Find Brands</a>
              </li>
              <li className="nav-item my-auto mx-3">
                <a className="nav-link text-dark" href="/login">Find Influencers</a>
              </li>
              <li className="nav-item my-auto mx-3">
                <a className="nav-link text-dark" href="/login">About</a>
              </li>
              <li className="nav-item my-auto mx-3">
                <a className="nav-link text-dark" href="/login">Contact</a>
              </li>
