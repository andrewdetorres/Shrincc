  ...
  render() {
    return (
      <>
        ...
        {/* Page Split */}
        <div className="d-flex container-fluid flex-md-row flex-column justify-content-center align-items-center p-5 mt-5 bg-primary">
        ...
        <div className="d-flex container-fluid flex-md-row flex-column justify-content-center align-items-stretch p-5 mt-2">
          <div className="card shadow border-0 py-3 mx-lg-5 mx-2 my-3 my-md-0 col-md-5">
