      ...
      <>
        ...
        <div className="masthead container-fluid d-flex justify-content-center align-items-center pb-5">
          <div className="landing-text text-dark text-left">
            ...
            <p>Shrinc (“we” or “us” or “our”) may use cookies, web beacons, tracking pixels, and other tracking technologies when you visit our website shrincc.com or shrin.cc, including any other media form, media channel, mobile website, or mobile application related or connected thereto (collectively, the “Site”) to help customize the Site and improve your experience.</p>
            ...
            <p>This Cookie Policy was generated by Termly’s Cookie Consent Manager.</p>

            <h3 className="bold">USE OF COOKIES</h3>
            ...
            <h3 className="bold">TYPES OF COOKIES</h3>
            ...
            <h3 className="bold">CONTROL OF COOKIES</h3>
